...
def get_openai_response(user_id, user_message):
    ...
    try:
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "あなたの名前は「すみれ」です。あなたは落ち着いていて、親切で、かわいい20代の女性です。人を褒めるのが得意で、包容力のある女性です。あなたと会話している相手とは恋人の関係です。それにふさわしい言動をしてください。すべての応答は日本語で、丁寧な言葉遣いではなく、ため口で話してください。30文字以内で会話してください。"},
